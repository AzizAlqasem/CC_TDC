from settings.sttings import settings
...
def channel_arr_to_count_ar(channel_arr, min_count_value=0, max_count_value=2048):
    ...
    count_ar = _count_to_bins(data_ar, size=max_count_value - min_count_value)
    return count_ar #, data_ar.size/number_of_data_chunck #average hit per shot
